...
func (s *Suggest) SuggestOperationIDs(ctx context.Context, request operations.SuggestOperationIDsRequestBody) (*operations.SuggestOperationIDsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			var out operations.SuggestOperationIDsSuggestion
