...
func (s *Organizations) CreateFreeTrial(ctx context.Context) (*operations.CreateFreeTrialResponse, error) {
...
func (s *Organizations) GetOrganizationUsage(ctx context.Context) (*operations.GetOrganizationUsageResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
